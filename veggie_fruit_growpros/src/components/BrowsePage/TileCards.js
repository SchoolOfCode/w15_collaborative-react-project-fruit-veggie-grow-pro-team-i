...
import potatoes from "../images/potato.png"
import tomatoimgs from "../images/tomato.png"
import carrots from "../images/carrot.png"
import onions from "../images/onion.png"
import strawberries from "../images/strawberry.png"
import blueberry from "../images/blueberry.png"
import raspberries from "../images/raspberry.png"
...
const TileCards = ({sortCardState,popUpMenu}) => {
  ...
  class Vegetables{
    ...
    makeCard(){
      ...
      return(
      <div key={this.id} 
      className="Cardbox__centreScreen--allCards" onClick={()=>{popUpMenu(this.img,this.title,DifficultyLeafImage,SpaceLeafImage,TimeLeafImage)}}>
        <span>
